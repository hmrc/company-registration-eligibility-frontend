...
import identifiers.CacheKeys.{identityVerification, paymentOption, secureRegister}
...
class SessionDataCacheServiceSpec extends SpecBase with MockitoSugar with ScalaFutures {
  ...
  "setSecureRegisterAndRedirectToNextPage" should {

    "redirect to next page when answers are successfully saved" in {
      successfulSaveTest(
        service.setSecureRegisterAndRedirectToNextPage,
        secureRegister
      )
    }
  ...
  "setPaymentOptionAndRedirectToNextPage" should {

    "redirect to next page when answers are successfully saved" in {
      successfulSaveTest(
        service.setPaymentOptionAndRedirectToNextPage,
        paymentOption
      )
    }
  ...
  "setIdentityVerificationAndRedirectToNextPage" should {

    "redirect to next page when answers are successfully saved" in {
      successfulSaveTest(
        service.setIdentityVerificationAndRedirectToNextPage,
