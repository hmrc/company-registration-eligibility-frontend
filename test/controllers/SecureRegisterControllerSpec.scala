...
class SecureRegisterControllerSpec extends ControllerSpecBase {
  ...
  val formProvider = new SecureRegisterFormProvider()
  val form = formProvider()

  def controller(dataRetrievalAction: DataRetrievalAction = getEmptyCacheMap) =
    new SecureRegisterController(frontendAppConfig, messagesApi, FakeDataCacheConnector, new FakeNavigator(desiredRoute = onwardRoute), FakeCacheIdentifierAction,
